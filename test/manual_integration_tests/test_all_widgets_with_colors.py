...
neotkinter.set_appearance_mode("System")  # Other: "Dark", "Light"


class TestApp(neotkinter.NTk):
    def __init__(self):
        super().__init__()
        ...
        self.create_widgets_on_ntk_frame_customized()
    ...
    def change_appearance_mode(self, value):
        ...
        if value == 0:
            ...
            neotkinter.set_appearance_mode("System")

    def create_widgets_on_tk(self):
        x, y = 150, 80

        self.label_1 = neotkinter.NTkLabel(master=self, text="widgets_on_tk", fg_color="gray50")
        self.label_1.place(x=x, y=y, anchor=tkinter.CENTER)

        self.frame_1 = neotkinter.NTkFrame(master=self, width=200, height=60)
        self.frame_1.place(x=x, y=y+80, anchor=tkinter.CENTER)

        self.button_1 = neotkinter.NTkButton(master=self)
        self.button_1.place(x=x, y=y + 160, anchor=tkinter.CENTER)

        self.entry_1 = neotkinter.NTkEntry(master=self)
        self.entry_1.place(x=x, y=y + 240, anchor=tkinter.CENTER)

        self.progress_bar_1 = neotkinter.NTkProgressBar(master=self)
        self.progress_bar_1.place(x=x, y=y + 320, anchor=tkinter.CENTER)

        self.slider_1 = neotkinter.NTkSlider(master=self, command=self.change_appearance_mode, from_=0, to=2, number_of_steps=2)
        self.slider_1.place(x=x, y=y + 400, anchor=tkinter.CENTER)

        self.check_box_1 = neotkinter.NTkCheckBox(master=self)
        self.check_box_1.place(x=x, y=y + 480, anchor=tkinter.CENTER)

    def create_widgets_on_ntk_frame(self):
        x, y = 450, 40

        self.ntk_frame = neotkinter.NTkFrame(master=self, width=300, height=600)
        self.ntk_frame.place(x=x, y=y, anchor=tkinter.N)

        self.label_2 = neotkinter.NTkLabel(master=self.ntk_frame, text="create_widgets_on_ntk_frame", fg_color="gray50", width=200)
        self.label_2.place(relx=0.5, y=y, anchor=tkinter.CENTER)

        self.frame_2 = neotkinter.NTkFrame(master=self.ntk_frame, width=200, height=60)
        self.frame_2.place(relx=0.5, y=y + 80, anchor=tkinter.CENTER)

        self.button_2 = neotkinter.NTkButton(master=self.ntk_frame, border_width=3)
        self.button_2.place(relx=0.5, y=y + 160, anchor=tkinter.CENTER)

        self.entry_2 = neotkinter.NTkEntry(master=self.ntk_frame)
        self.entry_2.place(relx=0.5, y=y + 240, anchor=tkinter.CENTER)

        self.progress_bar_2 = neotkinter.NTkProgressBar(master=self.ntk_frame)
        self.progress_bar_2.place(relx=0.5, y=y + 320, anchor=tkinter.CENTER)

        self.slider_2 = neotkinter.NTkSlider(master=self.ntk_frame, command=lambda v: self.label_2.configure(text=str(round(v, 5))))
        self.slider_2.place(relx=0.5, y=y + 400, anchor=tkinter.CENTER)

        self.check_box_2 = neotkinter.NTkCheckBox(master=self.ntk_frame)
    ...
    def change_frame_color(self, value):
        ...
        self.ntk_frame_customized.configure(fg_color=col_1)
        self.tk_frame_customized.configure(bg=col_1)
        self.configure(bg=col_2)
        self.progress_bar_3.set(value)

    def create_widgets_on_ntk_frame_customized(self):
        x, y = 800, 40

        self.ntk_frame_customized = neotkinter.NTkFrame(master=self, width=300, height=600)
        self.ntk_frame_customized.place(x=x, y=y, anchor=tkinter.N)
        self.ntk_frame_customized.configure(fg_color=("#F4F4FA", "#1E2742"))

        self.label_3 = neotkinter.NTkLabel(master=self.ntk_frame_customized, text="customized", corner_radius=60,
                                              font=("times", 16))
        ...
        self.frame_3 = neotkinter.NTkFrame(master=self.ntk_frame_customized, width=200, height=60)
        self.frame_3.place(relx=0.5, y=y + 80, anchor=tkinter.CENTER)
        self.frame_3.configure(fg_color=("#EBECF3", "#4B577E"))

        self.button_3 = neotkinter.NTkButton(master=self.ntk_frame_customized, command=lambda: None, border_width=3,
        ...
        self.entry_3 = neotkinter.NTkEntry(master=self.ntk_frame_customized, font=("times", 16))
        ...
        self.progress_bar_3 = neotkinter.NTkProgressBar(master=self.ntk_frame_customized, height=16, fg_color=("#EBECF3", "#4B577E"))
        ...
        self.slider_3 = neotkinter.NTkSlider(master=self.ntk_frame_customized, command=self.change_frame_color, from_=0, to=10)
        ...
        self.check_box_3 = neotkinter.NTkCheckBox(master=self.ntk_frame_customized, corner_radius=50, font=("times", 16))
    ...
    def create_widgets_on_tk_frame_customized(self):
        ...
        self.label_4 = neotkinter.NTkLabel(master=self.tk_frame_customized, text="customized", corner_radius=6)
        ...
        self.frame_4 = neotkinter.NTkFrame(master=self.tk_frame_customized, width=200, height=60)
        self.frame_4.place(relx=0.5, y=y + 80, anchor=tkinter.CENTER)
        self.frame_4.configure(fg_color=("#EBECF3", "#4B577E"))

        self.button_4 = neotkinter.NTkButton(master=self.tk_frame_customized, command=lambda: x, border_width=3)
        ...
        self.entry_4 = neotkinter.NTkEntry(master=self.tk_frame_customized)
        ...
        self.progress_bar_4 = neotkinter.NTkProgressBar(master=self.tk_frame_customized, height=16, fg_color=("#EBECF3", "#4B577E"))
        ...
        self.slider_4 = neotkinter.NTkSlider(master=self.tk_frame_customized, command=self.change_frame_color, from_=0, to=10)
        ...
        self.check_box_4 = neotkinter.NTkCheckBox(master=self.tk_frame_customized)
