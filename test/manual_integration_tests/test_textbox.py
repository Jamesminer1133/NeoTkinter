...
textbox_1 = neotkinter.NTkTextbox(app, fg_color=None, corner_radius=0, border_spacing=0)
...
frame_1 = neotkinter.NTkFrame(app, corner_radius=0)
frame_1.grid(row=0, column=1, sticky="nsew")
frame_1.grid_rowconfigure((0, 1, 2, 3, 4), weight=1)
frame_1.grid_columnconfigure(0, weight=1)

textbox_2 = neotkinter.NTkTextbox(frame_1, wrap="none")
...
textbox_2 = neotkinter.NTkTextbox(frame_1, wrap="none", corner_radius=30)
textbox_2.grid(row=1, column=0, sticky="nsew", padx=20, pady=20)
textbox_2.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_2 = neotkinter.NTkTextbox(frame_1, wrap="none", corner_radius=0, border_width=30)
textbox_2.grid(row=2, column=0, sticky="nsew", padx=20, pady=20)
textbox_2.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_2 = neotkinter.NTkTextbox(frame_1, wrap="none", corner_radius=60, border_width=15)
                                     #fg_color="blue", scrollbar_color="yellow", text_color="red")
textbox_2.grid(row=3, column=0, sticky="nsew", padx=20, pady=20)
textbox_2.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_2 = neotkinter.NTkTextbox(frame_1, wrap="none", corner_radius=0, border_width=0)
textbox_2.grid(row=4, column=0, sticky="nsew", padx=20, pady=20)
textbox_2.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

frame_2 = neotkinter.NTkFrame(app, corner_radius=0, fg_color=None)
frame_2.grid(row=0, column=2, sticky="nsew")
frame_2.grid_rowconfigure((0, 1, 2, 3, 4), weight=1)
frame_2.grid_columnconfigure(0, weight=1)

textbox_3 = neotkinter.NTkTextbox(frame_2)
...
textbox_3 = neotkinter.NTkTextbox(frame_2, corner_radius=30)
textbox_3.grid(row=1, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_3 = neotkinter.NTkTextbox(frame_2, corner_radius=0, border_width=30)
textbox_3.grid(row=2, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_3 = neotkinter.NTkTextbox(frame_2, corner_radius=60, border_width=15)
textbox_3.grid(row=3, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_3 = neotkinter.NTkTextbox(frame_2, corner_radius=0, border_width=0, border_spacing=20)
textbox_3.grid(row=4, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

frame_3 = neotkinter.NTkFrame(app, corner_radius=0, fg_color=None)
...
textbox_3 = neotkinter.NTkTextbox(frame_3, activate_scrollbars=False)
textbox_3.grid(row=0, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_3 = neotkinter.NTkTextbox(frame_3, corner_radius=10, border_width=2, activate_scrollbars=False)
textbox_3.grid(row=1, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_3 = neotkinter.NTkTextbox(frame_3, corner_radius=0, border_width=2, activate_scrollbars=False)
textbox_3.grid(row=2, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)
...
textbox_3 = neotkinter.NTkTextbox(frame_3, corner_radius=0, border_width=0, activate_scrollbars=False, border_spacing=10)
textbox_3.grid(row=4, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert("0.0", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n" * 20)

textbox_4 = neotkinter.NTkTextbox(app, fg_color=None, corner_radius=0)
...
scrollbar4 = neotkinter.NTkScrollbar(app, command=textbox_4.yview)
