...
def change_appearance_mode():
    ...
    app.after(1500, lambda: neotkinter.set_appearance_mode("light"))
    app.after(2500, toplevel.deiconify)

    # test appearance mode change while iconified
    app.after(3500, toplevel.iconify)
    app.after(4500, lambda: neotkinter.set_appearance_mode("dark"))
    ...
    if sys.platform.startswith("win"):
        ...
        app.after(7500, lambda: neotkinter.set_appearance_mode("light"))
        app.after(8500, lambda: toplevel.state("normal"))


button_1 = neotkinter.NTkButton(app, text="start test", command=change_appearance_mode)
