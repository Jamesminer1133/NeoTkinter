...
optionmenu_1 = neotkinter.NTkOptionMenu(app, variable=variable, values=countries, command=select_callback)
optionmenu_1.pack(pady=20, padx=10)

optionmenu_2 = neotkinter.NTkOptionMenu(app, variable=variable, values=countries, command=select_callback,
...
combobox_1 = neotkinter.NTkComboBox(app, variable=variable, values=countries, command=select_callback, width=300)
combobox_1.pack(pady=20, padx=10)

def set_new_scaling(scaling):
    neotkinter.set_window_scaling(scaling)
    neotkinter.set_widget_scaling(scaling)

scaling_slider = neotkinter.NTkSlider(app, command=set_new_scaling, from_=0, to=2)
