...
progressbar_1 = neotkinter.NTkProgressBar(app, orientation="horizontal")
progressbar_1.grid(row=0, column=0, pady=20, padx=20)

progressbar_2 = neotkinter.NTkProgressBar(app, orientation="vertical")
progressbar_2.grid(row=1, column=0, pady=20, padx=20)

slider_1 = neotkinter.NTkSlider(app, orientation="horizontal", command=progressbar_1.set,
                                   button_corner_radius=3, button_length=20)
slider_1.grid(row=2, column=0, pady=20, padx=20)

slider_2 = neotkinter.NTkSlider(app, orientation="vertical", command=progressbar_2.set,
                                   button_corner_radius=3, button_length=20)
