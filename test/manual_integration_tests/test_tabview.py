...
tabview_1 = neotkinter.NTkTabview(app)
...
b2 = neotkinter.NTkButton(master=tabview_1.tab("tab 2"), text="button tab 2")
b2.pack()
...
for i in range(10):
    for j in range(30):
        button = neotkinter.NTkButton(tabview_1.tab("tab 1"), height=10, width=30, font=neotkinter.NTkFont(size=8))
