'''
Advanced Scrollable Dropdown Frame class for neotkinter widgets
Author: Akash Bora
'''
...
class NTkScrollableDropdownFrame(NTkFrame):
    ...
    def __init__(self, attach, x=None, y=None, button_color=None, height: int = 200, width: int = None,
        ...
        self.frame = NTkScrollableFrame(self, fg_color=self.fg_color, bg_color=attach.cget("bg_color"),
        ...
        if double_click or self.attach.winfo_name().startswith("!ntkentry") or self.attach.winfo_name().startswith("!ntkcombobox"):
        ...
        if self.attach.winfo_name().startswith("!ntkcombobox"):
        ...
        if self.attach.winfo_name().startswith("!ntkoptionmenu"):
    ...
    def bind_autocomplete(self, ):
        ...
        if self.attach.winfo_name().startswith("!ntkentry"):
