"""
Menu Bar in Title Bar of neotkinter window
Author: Akash Bora
"""
...
class NTkTitleMenu(NTkToplevel):
    """
    A custom title bar menu widget for Windows NeoTkinter applications.
    ...
    def __init__(
        ...
        y_offset: int = None):
        """
        Initialize a NTkTitleMenu instance.
        ...
        if master_type=="tk":
            ...
            pass 
        elif isinstance(self.master, NTkToplevel):
            pass        
        ...
        if title_bar_color=="default":
            if neotkinter.get_appearance_mode()=="Light":
    ...
    def add_cascade(self, text=None, postcommand=None, **kwargs):
        ...
        if not "fg_color" in kwargs:
            fg_color = neotkinter.ThemeManager.theme["NTkFrame"]["fg_color"]
        else:
            fg_color = kwargs.pop("fg_color")
        if not "text_color" in kwargs:
            text_color = neotkinter.ThemeManager.theme["NTkLabel"]["text_color"]
        else:
        ...
        self.menu_button = neotkinter.NTkButton(self, text=text, fg_color=fg_color,
