...
from .widgets.appearance_mode import NTkAppearanceModeBaseClass

from neotkinter.windows.widgets.utility.utility_functions import pop_from_dict_by_set, check_kwargs_empty

NTK_PARENT_CLASS = tkinter.Tk


class NTk(NTK_PARENT_CLASS, NTkAppearanceModeBaseClass, NTkScalingBaseClass):
    """
    ...
    def __init__(self,
        ...
        NTK_PARENT_CLASS.__init__(self, **pop_from_dict_by_set(kwargs, self._valid_tk_constructor_arguments))
        NTkAppearanceModeBaseClass.__init__(self)
        NTkScalingBaseClass.__init__(self, scaling_type="window")
        ...
        self._fg_color = ThemeManager.theme["NTk"]["fg_color"] if fg_color is None else self._check_color_type(fg_color)
