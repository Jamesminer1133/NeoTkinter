...
from neotkinter.windows.widgets.ntk_textbox import NTkTextbox
...
from neotkinter.windows.widgets.appearance_mode import NTkAppearanceModeBaseClass
from tkinter import StringVar
from neotkinter.windows.widgets.ntk_text_menu import TextMenu
from tklinenums import TkLineNumbers
from pygments import lex
from pygments.lexers import python, javascript, c_cpp, dotnet, html, css, data, go, jvm, php, ruby, rust, scripting, perl, objective, jsx, special
from pygments.styles import get_style_by_name, get_all_styles

class AddLineNums(TkLineNumbers):
    """
    Class for adding line numbers in NTkTextbox using TkLineNumbers
    """
    def __init__(self,
                 master,
                 text_color=None,
...
class NTkCodeBox(NTkTextbox):
    """
    Widget for displaying code in NTk
    """
    def __init__(self,
                 master,
                 language,
        ...
        self.common_langs = {
            ...
            "react": jsx.JsxLexer,
            "special": special.OutputLexer,
            "txt": special.OutputLexer,
        }
