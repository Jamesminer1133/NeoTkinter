...
class ThemeManager:
    ...
    def load_theme(cls, theme_name_or_path: str):
        ...
        if "NTkCheckbox" in cls.theme.keys():
            cls.theme["NTkCheckBox"] = cls.theme.pop("NTkCheckbox")
        if "NTkRadiobutton" in cls.theme.keys():
            cls.theme["NTkRadioButton"] = cls.theme.pop("NTkRadiobutton")
