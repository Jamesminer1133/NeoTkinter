...
class NTkCanvas(tkinter.Canvas):
    """
    ...
    to look best for rendering NeoTkinter shapes on the different operating systems.
    ...
    def create_aa_circle(self, x_pos: int, y_pos: int, radius: int, angle: int = 0, fill: str = "white",
        ...
        self.addtag_withtag("ntk_aa_circle_font_element", circle_1)
    ...
    def coords(self, tag_or_id, *args):
        ...
        if type(tag_or_id) == str and "ntk_aa_circle_font_element" in self.gettags(tag_or_id):
