...
class NTkFrame(NTkBaseClass):
    ...
    def __init__(self,
        ...
        if fg_color is None:
            if isinstance(self.master, NTkFrame):
                if self.master._fg_color == ThemeManager.theme["NTkFrame"]["fg_color"]:
    ...
    def winfo_children(self) -> List[any]:
        """
        winfo_children of NTkFrame without self.canvas widget,
        because it's not a child but part of the NTkFrame itself
        """
    ...
    def configure(self, require_redraw=False, **kwargs):
        if "fg_color" in kwargs:
            ...
            # check if NTk widgets are children of the frame and change their bg_color to new frame fg_color
