...
class NTkLabel(NTkBaseClass):
    ...
    def __init__(self,
                 ...
                 image: Union[NTkImage, None] = None,
                 compound: str = "center",
        ...
        # color
        self._fg_color = ThemeManager.theme["NTkLabel"]["fg_color"] if fg_color is None else self._check_color_type(fg_color, transparency=True)
        self._text_color = ThemeManager.theme["NTkLabel"]["text_color"] if text_color is None else self._check_color_type(text_color)

        if text_color_disabled is None:
            if "text_color_disabled" in ThemeManager.theme["NTkLabel"]:
                self._text_color_disabled = ThemeManager.theme["NTkLabel"]["text_color"]
            else:
        ...
        # shape
        self._corner_radius = ThemeManager.theme["NTkLabel"]["corner_radius"] if corner_radius is None else corner_radius
