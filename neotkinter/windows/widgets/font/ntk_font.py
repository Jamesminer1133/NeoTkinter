...
class NTkFont(Font):
    ...
    def __init__(self,
        ...
        self._size = ThemeManager.theme["NTkFont"]["size"] if size is None else size

        super().__init__(family=ThemeManager.theme["NTkFont"]["family"] if family is None else family,
                         size=-abs(self._size),
                         weight=ThemeManager.theme["NTkFont"]["weight"] if weight is None else weight,
                         slant=slant,
                         underline=underline,
