...
NeoTkinter_directory = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
...
if FontManager.load_font(os.path.join(NeoTkinter_directory, "assets", "fonts", "CustomTkinter_shapes_font.otf")) is False:
    ...
    if DrawEngine.preferred_drawing_method == "font_shapes":
        sys.stderr.write("NeoTkinter.windows.widgets.font warning: " +
