...
class NTkScrollbar(NTkBaseClass):
    """
    ...
    def __init__(self,
        ...
        # color
        self._fg_color = ThemeManager.theme["NTkScrollbar"]["fg_color"] if fg_color is None else self._check_color_type(fg_color, transparency=True)
        self._button_color = ThemeManager.theme["NTkScrollbar"]["button_color"] if button_color is None else self._check_color_type(button_color)
        self._button_hover_color = ThemeManager.theme["NTkScrollbar"]["button_hover_color"] if button_hover_color is None else self._check_color_type(button_hover_color)

        # shape
        self._corner_radius = ThemeManager.theme["NTkScrollbar"]["corner_radius"] if corner_radius is None else corner_radius
        self._border_spacing = ThemeManager.theme["NTkScrollbar"]["border_spacing"] if border_spacing is None else border_spacing
